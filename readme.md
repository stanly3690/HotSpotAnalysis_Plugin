...
The plugin generates a shapefile which includes the Z-scores and p-values (Geits-Ord Gi*) computed from a points shapefile using feature coordinates and a correspondent numerical attribute.   
